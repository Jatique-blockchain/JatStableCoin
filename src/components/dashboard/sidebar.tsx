...
//                 <span className="text-[15px] ml-4 text-gray-200">Deposit</span>
//                 <motion.span
...
//               <FaMoneyBillWave />
//               <div className="flex justify-between w-full items-center">
//                 <span className="text-[15px] ml-4 text-gray-200">Withdraw</span>
//                 <motion.span
...
//                 >
//                   <Link
//                     href={"/dashboard/withdraw/now"}
//                     className={`cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1 ${isActive(
//                       "/dashboard/withdraw/now"
//                     )}`}
//                   >
//                     Withdraw Now
//                   </Link>
